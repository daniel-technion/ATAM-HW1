...
cmp %r8d, -4(%rcx, %rdi, 4)
cmovne %r8d, (%rcx, %rdi, 4)     # move to merged only if not equal to the last one
jmp continue1_HW1
copyArr1First_HW1:
movl %r8d, (%rcx, %rdi, 4)
continue1_HW1:
